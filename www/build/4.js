webpackJsonp([4],Array(340).concat([
/* 340 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile__ = __webpack_require__(599);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_firebase__ = __webpack_require__(415);
...
var ProfilePage = (function () {
    function ProfilePage(navCtrl, navParams, formBuilder, loadingCtrl, api) {
    ...
    //Fetch Worker Data.
    ProfilePage.prototype.getWorker = function (worker_id) {
        var _this = this;
        this.api.getWorker(worker_id).subscribe(function (response) {
            _this.worker = response.worker;
        }, function (error) { console.log(error); });
    };
    //Fetch Worker Data.
    ProfilePage.prototype.updateUser = function (worker_id) {
        var _this = this;
        var new_user = {
            email: this.user.get('email').value,
            phone: this.user.get('phone').value
        };
        __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.auth().currentUser.updateEmail(new_user.email).then(function () {
            _this.api.updateWorker(_this.worker_id, new_user).subscribe(function (response) {
                _this.getWorker(_this.worker_id);
            });
    ...
    ProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-profile',template:/*ion-inline-start:"/home/db8/Documents/Projects/cl_operator/src/pages/profile/profile.html"*/'<!--\n  Generated template for the ProfilePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>{{worker.name}} {{worker.last_name}}</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n        <form [formGroup]="user" (ngSubmit)="updateUser()" text-center >\n        <ion-row justify-content-center>\n          <ion-col col-10 text-left>\n            <ion-item>\n              <ion-label floating>Email</ion-label>\n              <ion-input type="email" formControlName="email" value="{{worker.email}}">jose@carlab.com</ion-input>\n            </ion-item>\n          </ion-col>\n          <ion-col col-10 text-left>\n            <ion-item>\n              <ion-label floating>Celular</ion-label>\n              <ion-input type="text" formControlName="phone" value="{{worker.phone}}">8712198235</ion-input>\n            </ion-item>\n          </ion-col>\n          <ion-col col-10 text-center margin-top margin-bottom>\n            <button ion-button  color="carlabC" block  type="submit" >\n              Actualizar Datos\n            </button>\n          </ion-col>\n        </ion-row>\n        </form>\n    </ion-row>\n    <ion-row>\n      <h1>Puntuación</h1>\n    </ion-row>\n    <ion-row justify-content-center>\n      <h1>{{worker.rating}}</h1>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/home/db8/Documents/Projects/cl_operator/src/pages/profile/profile.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_3__providers_api_service_api_service__["a" /* ApiServiceProvider */]])
    ], ProfilePage);
    return ProfilePage;
}());
