webpackJsonp([5],Array(338).concat([
/* 338 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase__ = __webpack_require__(415);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angularfire2_auth__ = __webpack_require__(219);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = (function () {
    function LoginPage(navCtrl, navParams, formBuilder, facebook, fire, loadingCtrl) {
        var _this = this;
        ...
        __WEBPACK_IMPORTED_MODULE_3_firebase___default.a.auth().onAuthStateChanged(function (currentUser) {
            if (currentUser) {
    ...
    LoginPage.prototype.loginWithEmail = function () {
        ...
        loading.present();
        this.fire.auth.signInWithEmailAndPassword(this.user.get('email').value, this.user.get('password').value).catch(function (error) {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/home/db8/Documents/Projects/cl_operator/src/pages/login/login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <!-- <ion-navbar hide-nav-bar>\n  </ion-navbar> -->\n\n</ion-header>\n\n\n<ion-content disable-scroll>\n  <ion-grid>\n    <ion-row align-items:center margin wrap>\n      <ion-col col-12 text-center>\n        <img src="assets/imgs/carlab_logo.png">\n      </ion-col>\n      <ion-col col-12 text-center>\n        <p>Valoramos tu tiempo, cuidamos tu auto.</p>\n      </ion-col>\n    </ion-row>\n      <form [formGroup]="user" (ngSubmit)="loginWithEmail()" text-center >\n      <ion-row justify-content-center>\n        <ion-col col-10 text-center>\n          <ion-item>\n            <ion-label floating>Email</ion-label>\n            <ion-input type="email" formControlName="email"></ion-input>\n          </ion-item>\n        </ion-col>\n        <ion-col col-10 text-center>\n          <ion-item>\n            <ion-label floating>Password</ion-label>\n            <ion-input type="password" formControlName="password"></ion-input>\n          </ion-item>\n        </ion-col>\n        <ion-col col-10 text-center margin-top margin-bottom>\n          <button ion-button icon-start color="carlabC" block [disabled]="!user.valid" type="submit" >\n            <ion-icon name="md-mail" ></ion-icon>\n            Login\n          </button>\n        </ion-col>\n      </ion-row>\n      </form>\n      <!-- <ion-row justify-content-center>\n        <ion-col col-10 text-center margin-top margin-bottom text-center>\n          <button ion-button icon-start   block (click)="facebookLogin()">\n            <ion-icon name="logo-facebook"></ion-icon>\n            Inicia sesión\n          </button>\n        </ion-col>\n      </ion-row> -->\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/home/db8/Documents/Projects/cl_operator/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_5_angularfire2_auth__["a" /* AngularFireAuth */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */]])
    ], LoginPage);
    return LoginPage;
}());
